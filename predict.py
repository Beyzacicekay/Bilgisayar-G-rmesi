...
model = YOLO('runs/detect/train2/weights/best.pt')  # Eğitilmiş modelin yolunu belirtin

# Test klasörünün yolunu belirleyin
test_images_folder = "C:/Users/Beyza/PycharmProjects/Kayisi/Kayısı--1/test/images"
